...
## 2026-07-18 — Market Intel (regime_trader)
| Source | Type | Item | Regime Signal | Vol Bias | Relevance |
|--------|------|------|----------------|----------|-----------|
| WSJ Markets | blog | "China's Moonshot AI Adds More Fuel to Wall Street's Chip Selloff"; "Nasdaq Drops Again as Chip Slump Deepens" (Netflix growth warning) | New, distinct AI/chip-sector selloff dragging Nasdaq, separate from Iran shock | HIGH (QQQ-specific) | High |
| ETF Trends (VettaFi) | blog | S&P 500 Snapshot: -1.6% weekly loss, 2.0% below June 2 record, still +8.9% YTD; below 50-day MA | Hard price confirmation of week's tech-driven damage | HIGH | High |
| WSJ Markets / Seeking Alpha / CNBC | blog | Oil futures +double-digit week / crude +15% on renewed U.S.-Iran strikes; gas "higher for longer"; diesel supply crunch; ECB rate decision rethink amid "extremely volatile" outlook | Iran/Hormuz war still live, now hitting a second central bank (ECB) | HIGH | High |
| CNBC — Finance | blog | New Fed Chair Kevin Warsh pledges policy "regime change" vs inflation; discontinues dot plot, curtails forward guidance (per ETF Trends/American Century) | Reduced Fed forward-guidance signal at a sensitive transition | Uncertainty-raising | High — HMM input change |
| CNBC — Finance | blog | Dallas Fed's Logan wants "modestly" higher rates; Waller warns hikes still possible; vs NY Fed's Williams says inflation "has peaked," rates "well positioned" | Fed direction genuinely contested, not consensus-hawkish | Mixed | High |
| CNBC — Economy | blog | June CPI +3.5% y/y (vs 3.8% expected, down from May 4.2%); PPI -0.3%; core ~2.9% (ETF Trends) | Headline disinflation better than expected | Dovish counter-signal | High |
| CNBC — Economy | blog | Import prices +0.3%, China-sourced goods costs highest since 2008 | Tariff pass-through still active beneath headline cooling | Supports HIGH (fragile disinflation) | High |
| ETF Trends (VettaFi) | blog | Small-cap rally "strong fundamental legs," Russell 2000 outpacing S&P; separate piece: "Now's the Time for Emerging Markets" (diversify from AI hyperscalers) | Rotation: IWM > SPY > QQQ this week, now data-backed | Rotation signal | High — direct SPY/QQQ/IWM split |
| WSJ Markets / CNBC — Finance | blog | "Wall Street Traders Are Having Their Best Year Ever" (banks' trading revenue booming, "extremely risk-on"); big banks poised for booming Q2 revenue from SpaceX IPO + Iran war volatility | Elevated trading volume/volatility, not necessarily bullish sentiment — some tension vs AI-selloff risk-off framing | Ambiguous | Med-High |
| Investing.com — Market Overview (3 headlines, title-only) | blog (title-only) | "Risk-Off Rolls Into Friday"; "Stocks Tumble as AI Selloff Deepens and US-Iran Strikes Support Oil"; "Friday Market Outlook: Is a Bigger Selloff About to Begin?" | Same-day convergence on dual selloff drivers | HIGH | Med — title-only but internally consistent |
| Oseille TV | youtube (title-only) | "Ces pays d'Afrique vendent leur passeport (et c'est 100% légal)" | UEMOA/Africa wealth-mgmt priority flag — content unknown | n/a | Priority — needs transcript |
| Finary (2 items), Investing Simplified (2), George Gammon (2), IG France (7) | youtube (title-only) | Currency-value, retirement, "AI bubble popped," EUR/USD and Iran-impact French MarketLive videos | Unknown content — all title-only, no cached transcripts | Low confidence | Low — pending transcript fetch (queue now 15 pending) |
| Motley Fool (50 items), Yahoo Finance (20), Investing.com — Stock Market News (10), Seeking Alpha (7 remaining), WSJ Markets (~35 remaining), ETF Trends (~35 remaining), Big Picture/Fed/Liberty Street/FRED (remaining) | mixed | Single-stock deep-dives, deals/M&A, opinion columns, niche-ETF product pieces, institutional/background research | — | — | Low — outside ETF-only mandate or background-only |
